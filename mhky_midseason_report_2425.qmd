...
#| warning: false
#| echo: false
player_stats <- read_csv("/Users/hudsonholman/Documents/Work/Varsity Analytics/2024-25 Mens Hockey/data files/2024-25_players.csv",
...
goalie_stats <- read_csv("/Users/hudsonholman/Documents/Work/Varsity Analytics/2024-25 Mens Hockey/data files/2024-25_goalies.csv",
                         col_names = c("number", "player",
                                       "game_id", "home_away",
                                       "win", "loss", "otw", "otl",
                                       "sow", "sol", "minutes", 
...
team_stats <- read_csv("/Users/hudsonholman/Documents/Work/Varsity Analytics/2024-25 Mens Hockey/data files/2024-25_team.csv",
...
game_id <- read_csv("/Users/hudsonholman/Documents/Work/Varsity Analytics/2024-25 Mens Hockey/data files/game_id_info.csv")
game_id <- game_id |>
  separate(game_id, into = c("date", "opponent"), sep = "-")
game_id$date <- ymd(game_id$date)

roster <- read_csv("/Users/hudsonholman/Documents/Work/Varsity Analytics/2024-25 Mens Hockey/data files/roster.csv")
```
...
-   Give up most shots in the 1st, but most goals in the 3rd.

-   PP % high at home in the 3rd period.

-   Losing net front, odd man, and grade As on average.

## Net Front

Relationship between winning and our net front
...
Relationship between winning and odd man
...
Relationship between winning and grade A chances.
  ...
  summarise(
    ...
    block_shots = c(sum(block_shots[home_away == "Home"
           ...
           sum(block_shots[home_away == "Away"
                           & date >= as.Date("2024-10-03")]),
           sum(block_shots[date >= as.Date("2024-10-03")]),
           sum(block_shots)),
...
shooting_stats <- player_stats |>
  ...
  summarise(gp = n_distinct(date),
            ...
            shots_game = sum(shots)/n_distinct(date),
            shot_att_game = sum(shot_attempts)/n_distinct(date),
...
goalie_summary <- goalie_stats |>
  ...
  summarise(
    ...
    avg_goals_against = c(
      sum(ga[month == "September"])/sum(month == "September"),
      sum(ga[month == "October"])/sum(month == "October"),
      sum(ga[month == "November"])/sum(month == "November"),
      sum(ga[month == "December"])/sum(month == "December"),
      sum(ga[home_away == "Home"
             & date >= as.Date("2024-10-03")])
      /sum(home_away == "Home"
           & date >= as.Date("2024-10-03")),
...
Over the past 4 months (all games), how consistent are they?
...
This shows that Onuska has had higher save percentages and been more consistent through the first half.

## Rebound Control

Relationship between save percentage and rebound control across all games.
...
This shows that Murphy's save percentage tends to be lower when he gives up a lot of rebounds and Onuska's save percentage tends to be higher when he gives up a lot of rebounds.

# Extensions

Pull data from InStat and do additional analysis. Especially things like faceoffs.
...
instat <- read_xlsx("/Users/hudsonholman/Documents/Work/Varsity Analytics/2024-25 Mens Hockey/data files/instat_pull_2024_12.xlsx")
